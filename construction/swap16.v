// 16-bit masked constant-product SWAP demonstrator — the DEX swap program
// over 218 O-PINI2 masked-AND leaves. VERIFIED TARGET.
...
module swap16 (clk, rst, go, x, ri, ro, mo, r, s, aout, nri, nro, ok);
