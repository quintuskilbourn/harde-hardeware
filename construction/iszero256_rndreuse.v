// NEGATIVE CONTROL (must FAIL): identical to iszero256 except gadget 1 consumes
...
module iszero256_rndreuse (clk, rst, go, a, r, s, out);
...
wire w0_1, w1_1;
MSKand_opini2_d2 u_or_1 (  // BUG UNDER TEST: reuses gadget 0's randomness r[0]/s[0]
    .ina({ina1_1, ina0_1}), .inb({a[7], ny0_1}),
    .rnd(r[0]), .s(s[0]), .clk(clk), .out({w1_1, w0_1}));
