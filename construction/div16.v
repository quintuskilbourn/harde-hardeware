// 16-bit masked DIV/MOD (EVM, B != 0: q = A/B, rem = A%B) — iterative
// restoring divider over 50 O-PINI2 masked-AND leaves. VERIFIED TARGET.
...
module div16 (clk, rst, go, a, b, r, s, q, rem);
