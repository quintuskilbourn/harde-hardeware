// NEGATIVE CONTROL (must FAIL): identical to the target except u_m_1
...
module div256_rndreuse (clk, rst, go, a, b, r, s, q, rem);
...
MSKand_opini2_d2 u_m_1 (  // BUG UNDER TEST: reuses u_m_0's randomness
    .ina({xm_d1[1], xm_d0[1]}), .inb({coutr1, coutr0}),
    .rnd(r[514]), .s(s[514]), .clk(clk), .out({w_m1[1], w_m0[1]}));
