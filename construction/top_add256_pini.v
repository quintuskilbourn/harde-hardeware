// LABEL CONTROL (EXPECTED PASS, single-pass): identical dataflow to
...
module top_add256_pini (clk, rst, go, sub, a, b, r, s, sum, cout);
...
MSKand_opini2_d2_pini u_generate_0 (
    .ina({a[1], a[0]}), .inb({b[1], b0_eff_0}),
    .rnd(r[0]), .s(s[0]), .clk(clk), .out({g1_0, g0_0}));
MSKand_opini2_d2_pini u_propagate_0 (
...
MSKand_opini2_d2_pini u_generate_1 (
    .ina({a[3], a[2]}), .inb({b[3], b0_eff_1}),
    .rnd(r[2]), .s(s[2]), .clk(clk), .out({g1_1, g0_1}));
MSKand_opini2_d2_pini u_propagate_1 (
...
MSKand_opini2_d2_pini u_generate_2 (
    .ina({a[5], a[4]}), .inb({b[5], b0_eff_2}),
    .rnd(r[4]), .s(s[4]), .clk(clk), .out({g1_2, g0_2}));
MSKand_opini2_d2_pini u_propagate_2 (
...
MSKand_opini2_d2_pini u_generate_3 (
    .ina({a[7], a[6]}), .inb({b[7], b0_eff_3}),
    .rnd(r[6]), .s(s[6]), .clk(clk), .out({g1_3, g0_3}));
MSKand_opini2_d2_pini u_propagate_3 (
...
MSKand_opini2_d2_pini u_generate_4 (
    .ina({a[9], a[8]}), .inb({b[9], b0_eff_4}),
    .rnd(r[8]), .s(s[8]), .clk(clk), .out({g1_4, g0_4}));
MSKand_opini2_d2_pini u_propagate_4 (
...
MSKand_opini2_d2_pini u_generate_5 (
    .ina({a[11], a[10]}), .inb({b[11], b0_eff_5}),
    .rnd(r[10]), .s(s[10]), .clk(clk), .out({g1_5, g0_5}));
MSKand_opini2_d2_pini u_propagate_5 (
...
MSKand_opini2_d2_pini u_generate_6 (
    .ina({a[13], a[12]}), .inb({b[13], b0_eff_6}),
    .rnd(r[12]), .s(s[12]), .clk(clk), .out({g1_6, g0_6}));
MSKand_opini2_d2_pini u_propagate_6 (
...
MSKand_opini2_d2_pini u_generate_7 (
    .ina({a[15], a[14]}), .inb({b[15], b0_eff_7}),
    .rnd(r[14]), .s(s[14]), .clk(clk), .out({g1_7, g0_7}));
MSKand_opini2_d2_pini u_propagate_7 (
...
MSKand_opini2_d2_pini u_generate_8 (
    .ina({a[17], a[16]}), .inb({b[17], b0_eff_8}),
    .rnd(r[16]), .s(s[16]), .clk(clk), .out({g1_8, g0_8}));
MSKand_opini2_d2_pini u_propagate_8 (
...
MSKand_opini2_d2_pini u_generate_9 (
    .ina({a[19], a[18]}), .inb({b[19], b0_eff_9}),
    .rnd(r[18]), .s(s[18]), .clk(clk), .out({g1_9, g0_9}));
MSKand_opini2_d2_pini u_propagate_9 (
...
MSKand_opini2_d2_pini u_generate_10 (
    .ina({a[21], a[20]}), .inb({b[21], b0_eff_10}),
    .rnd(r[20]), .s(s[20]), .clk(clk), .out({g1_10, g0_10}));
MSKand_opini2_d2_pini u_propagate_10 (
...
MSKand_opini2_d2_pini u_generate_11 (
    .ina({a[23], a[22]}), .inb({b[23], b0_eff_11}),
    .rnd(r[22]), .s(s[22]), .clk(clk), .out({g1_11, g0_11}));
MSKand_opini2_d2_pini u_propagate_11 (
...
MSKand_opini2_d2_pini u_generate_12 (
    .ina({a[25], a[24]}), .inb({b[25], b0_eff_12}),
    .rnd(r[24]), .s(s[24]), .clk(clk), .out({g1_12, g0_12}));
MSKand_opini2_d2_pini u_propagate_12 (
...
MSKand_opini2_d2_pini u_generate_13 (
    .ina({a[27], a[26]}), .inb({b[27], b0_eff_13}),
    .rnd(r[26]), .s(s[26]), .clk(clk), .out({g1_13, g0_13}));
MSKand_opini2_d2_pini u_propagate_13 (
...
MSKand_opini2_d2_pini u_generate_14 (
    .ina({a[29], a[28]}), .inb({b[29], b0_eff_14}),
    .rnd(r[28]), .s(s[28]), .clk(clk), .out({g1_14, g0_14}));
MSKand_opini2_d2_pini u_propagate_14 (
...
MSKand_opini2_d2_pini u_generate_15 (
    .ina({a[31], a[30]}), .inb({b[31], b0_eff_15}),
    .rnd(r[30]), .s(s[30]), .clk(clk), .out({g1_15, g0_15}));
MSKand_opini2_d2_pini u_propagate_15 (
...
MSKand_opini2_d2_pini u_generate_16 (
    .ina({a[33], a[32]}), .inb({b[33], b0_eff_16}),
    .rnd(r[32]), .s(s[32]), .clk(clk), .out({g1_16, g0_16}));
MSKand_opini2_d2_pini u_propagate_16 (
...
MSKand_opini2_d2_pini u_generate_17 (
    .ina({a[35], a[34]}), .inb({b[35], b0_eff_17}),
    .rnd(r[34]), .s(s[34]), .clk(clk), .out({g1_17, g0_17}));
MSKand_opini2_d2_pini u_propagate_17 (
...
MSKand_opini2_d2_pini u_generate_18 (
    .ina({a[37], a[36]}), .inb({b[37], b0_eff_18}),
    .rnd(r[36]), .s(s[36]), .clk(clk), .out({g1_18, g0_18}));
MSKand_opini2_d2_pini u_propagate_18 (
...
MSKand_opini2_d2_pini u_generate_19 (
    .ina({a[39], a[38]}), .inb({b[39], b0_eff_19}),
    .rnd(r[38]), .s(s[38]), .clk(clk), .out({g1_19, g0_19}));
MSKand_opini2_d2_pini u_propagate_19 (
...
MSKand_opini2_d2_pini u_generate_20 (
    .ina({a[41], a[40]}), .inb({b[41], b0_eff_20}),
    .rnd(r[40]), .s(s[40]), .clk(clk), .out({g1_20, g0_20}));
MSKand_opini2_d2_pini u_propagate_20 (
...
MSKand_opini2_d2_pini u_generate_21 (
    .ina({a[43], a[42]}), .inb({b[43], b0_eff_21}),
    .rnd(r[42]), .s(s[42]), .clk(clk), .out({g1_21, g0_21}));
MSKand_opini2_d2_pini u_propagate_21 (
...
MSKand_opini2_d2_pini u_generate_22 (
    .ina({a[45], a[44]}), .inb({b[45], b0_eff_22}),
    .rnd(r[44]), .s(s[44]), .clk(clk), .out({g1_22, g0_22}));
MSKand_opini2_d2_pini u_propagate_22 (
...
MSKand_opini2_d2_pini u_generate_23 (
    .ina({a[47], a[46]}), .inb({b[47], b0_eff_23}),
    .rnd(r[46]), .s(s[46]), .clk(clk), .out({g1_23, g0_23}));
MSKand_opini2_d2_pini u_propagate_23 (
...
MSKand_opini2_d2_pini u_generate_24 (
    .ina({a[49], a[48]}), .inb({b[49], b0_eff_24}),
    .rnd(r[48]), .s(s[48]), .clk(clk), .out({g1_24, g0_24}));
MSKand_opini2_d2_pini u_propagate_24 (
...
MSKand_opini2_d2_pini u_generate_25 (
    .ina({a[51], a[50]}), .inb({b[51], b0_eff_25}),
    .rnd(r[50]), .s(s[50]), .clk(clk), .out({g1_25, g0_25}));
MSKand_opini2_d2_pini u_propagate_25 (
...
MSKand_opini2_d2_pini u_generate_26 (
    .ina({a[53], a[52]}), .inb({b[53], b0_eff_26}),
    .rnd(r[52]), .s(s[52]), .clk(clk), .out({g1_26, g0_26}));
MSKand_opini2_d2_pini u_propagate_26 (
...
MSKand_opini2_d2_pini u_generate_27 (
    .ina({a[55], a[54]}), .inb({b[55], b0_eff_27}),
    .rnd(r[54]), .s(s[54]), .clk(clk), .out({g1_27, g0_27}));
MSKand_opini2_d2_pini u_propagate_27 (
...
MSKand_opini2_d2_pini u_generate_28 (
    .ina({a[57], a[56]}), .inb({b[57], b0_eff_28}),
    .rnd(r[56]), .s(s[56]), .clk(clk), .out({g1_28, g0_28}));
MSKand_opini2_d2_pini u_propagate_28 (
...
MSKand_opini2_d2_pini u_generate_29 (
    .ina({a[59], a[58]}), .inb({b[59], b0_eff_29}),
    .rnd(r[58]), .s(s[58]), .clk(clk), .out({g1_29, g0_29}));
MSKand_opini2_d2_pini u_propagate_29 (
...
MSKand_opini2_d2_pini u_generate_30 (
    .ina({a[61], a[60]}), .inb({b[61], b0_eff_30}),
    .rnd(r[60]), .s(s[60]), .clk(clk), .out({g1_30, g0_30}));
MSKand_opini2_d2_pini u_propagate_30 (
...
MSKand_opini2_d2_pini u_generate_31 (
    .ina({a[63], a[62]}), .inb({b[63], b0_eff_31}),
    .rnd(r[62]), .s(s[62]), .clk(clk), .out({g1_31, g0_31}));
MSKand_opini2_d2_pini u_propagate_31 (
...
MSKand_opini2_d2_pini u_generate_32 (
    .ina({a[65], a[64]}), .inb({b[65], b0_eff_32}),
    .rnd(r[64]), .s(s[64]), .clk(clk), .out({g1_32, g0_32}));
MSKand_opini2_d2_pini u_propagate_32 (
...
MSKand_opini2_d2_pini u_generate_33 (
    .ina({a[67], a[66]}), .inb({b[67], b0_eff_33}),
    .rnd(r[66]), .s(s[66]), .clk(clk), .out({g1_33, g0_33}));
MSKand_opini2_d2_pini u_propagate_33 (
...
MSKand_opini2_d2_pini u_generate_34 (
    .ina({a[69], a[68]}), .inb({b[69], b0_eff_34}),
    .rnd(r[68]), .s(s[68]), .clk(clk), .out({g1_34, g0_34}));
MSKand_opini2_d2_pini u_propagate_34 (
...
MSKand_opini2_d2_pini u_generate_35 (
    .ina({a[71], a[70]}), .inb({b[71], b0_eff_35}),
    .rnd(r[70]), .s(s[70]), .clk(clk), .out({g1_35, g0_35}));
MSKand_opini2_d2_pini u_propagate_35 (
...
MSKand_opini2_d2_pini u_generate_36 (
    .ina({a[73], a[72]}), .inb({b[73], b0_eff_36}),
    .rnd(r[72]), .s(s[72]), .clk(clk), .out({g1_36, g0_36}));
MSKand_opini2_d2_pini u_propagate_36 (
...
MSKand_opini2_d2_pini u_generate_37 (
    .ina({a[75], a[74]}), .inb({b[75], b0_eff_37}),
    .rnd(r[74]), .s(s[74]), .clk(clk), .out({g1_37, g0_37}));
MSKand_opini2_d2_pini u_propagate_37 (
...
MSKand_opini2_d2_pini u_generate_38 (
    .ina({a[77], a[76]}), .inb({b[77], b0_eff_38}),
    .rnd(r[76]), .s(s[76]), .clk(clk), .out({g1_38, g0_38}));
MSKand_opini2_d2_pini u_propagate_38 (
...
MSKand_opini2_d2_pini u_generate_39 (
    .ina({a[79], a[78]}), .inb({b[79], b0_eff_39}),
    .rnd(r[78]), .s(s[78]), .clk(clk), .out({g1_39, g0_39}));
MSKand_opini2_d2_pini u_propagate_39 (
...
MSKand_opini2_d2_pini u_generate_40 (
    .ina({a[81], a[80]}), .inb({b[81], b0_eff_40}),
    .rnd(r[80]), .s(s[80]), .clk(clk), .out({g1_40, g0_40}));
MSKand_opini2_d2_pini u_propagate_40 (
...
MSKand_opini2_d2_pini u_generate_41 (
    .ina({a[83], a[82]}), .inb({b[83], b0_eff_41}),
    .rnd(r[82]), .s(s[82]), .clk(clk), .out({g1_41, g0_41}));
MSKand_opini2_d2_pini u_propagate_41 (
...
MSKand_opini2_d2_pini u_generate_42 (
    .ina({a[85], a[84]}), .inb({b[85], b0_eff_42}),
    .rnd(r[84]), .s(s[84]), .clk(clk), .out({g1_42, g0_42}));
MSKand_opini2_d2_pini u_propagate_42 (
...
MSKand_opini2_d2_pini u_generate_43 (
    .ina({a[87], a[86]}), .inb({b[87], b0_eff_43}),
    .rnd(r[86]), .s(s[86]), .clk(clk), .out({g1_43, g0_43}));
MSKand_opini2_d2_pini u_propagate_43 (
...
MSKand_opini2_d2_pini u_generate_44 (
    .ina({a[89], a[88]}), .inb({b[89], b0_eff_44}),
    .rnd(r[88]), .s(s[88]), .clk(clk), .out({g1_44, g0_44}));
MSKand_opini2_d2_pini u_propagate_44 (
...
MSKand_opini2_d2_pini u_generate_45 (
    .ina({a[91], a[90]}), .inb({b[91], b0_eff_45}),
    .rnd(r[90]), .s(s[90]), .clk(clk), .out({g1_45, g0_45}));
MSKand_opini2_d2_pini u_propagate_45 (
...
MSKand_opini2_d2_pini u_generate_46 (
    .ina({a[93], a[92]}), .inb({b[93], b0_eff_46}),
    .rnd(r[92]), .s(s[92]), .clk(clk), .out({g1_46, g0_46}));
MSKand_opini2_d2_pini u_propagate_46 (
...
MSKand_opini2_d2_pini u_generate_47 (
    .ina({a[95], a[94]}), .inb({b[95], b0_eff_47}),
    .rnd(r[94]), .s(s[94]), .clk(clk), .out({g1_47, g0_47}));
MSKand_opini2_d2_pini u_propagate_47 (
...
MSKand_opini2_d2_pini u_generate_48 (
    .ina({a[97], a[96]}), .inb({b[97], b0_eff_48}),
    .rnd(r[96]), .s(s[96]), .clk(clk), .out({g1_48, g0_48}));
MSKand_opini2_d2_pini u_propagate_48 (
...
MSKand_opini2_d2_pini u_generate_49 (
    .ina({a[99], a[98]}), .inb({b[99], b0_eff_49}),
    .rnd(r[98]), .s(s[98]), .clk(clk), .out({g1_49, g0_49}));
MSKand_opini2_d2_pini u_propagate_49 (
