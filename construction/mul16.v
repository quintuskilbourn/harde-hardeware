// 16-bit masked MUL (EVM: prod = A*B mod 2^16) — iterative carry-save
// multiplier over 76 O-PINI2 masked-AND leaves. VERIFIED TARGET.
...
module mul16 (clk, rst, go, a, b, r, s, prod);
