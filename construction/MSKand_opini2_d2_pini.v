...
// for structural fidelity, but NON-VACUOUSNESS CONTROL: identical O-PINI2 circuit relabeled PINI; must FAIL.
//
// Pipeline latencies: inb@0, rnd@0, ina@1, s@1, out@3.
(* matchi_prop = "PINI", matchi_strat = "assumed", matchi_shares = 2, matchi_arch = "pipeline" *)
module MSKand_opini2_d2_pini (ina, inb, rnd, s, clk, out);
