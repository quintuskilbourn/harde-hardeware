// NEGATIVE CONTROL (must FAIL): identical to top_add256_opini2 except bit 0's
...
module top_add256_rndreuse (clk, rst, go, sub, a, b, r, s, sum, cout);
...
MSKand_opini2_d2 u_propagate_0 (
    ...
    .rnd(r[0]), .s(s[0]), .clk(clk), .out({t1_0, t0_0}));
