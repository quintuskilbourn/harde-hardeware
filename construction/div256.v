// 256-bit masked DIV/MOD (EVM, B != 0: q = A/B, rem = A%B) — iterative
// restoring divider over 770 O-PINI2 masked-AND leaves. VERIFIED TARGET.
...
module div256 (clk, rst, go, a, b, r, s, q, rem);
