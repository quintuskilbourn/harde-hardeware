// 256-bit masked MUL (EVM: prod = A*B mod 2^256) — iterative carry-save
// multiplier over 1276 O-PINI2 masked-AND leaves. VERIFIED TARGET.
...
module mul256 (clk, rst, go, a, b, r, s, prod);
