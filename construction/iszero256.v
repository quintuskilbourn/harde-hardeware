// 256-bit masked ISZERO — balanced binary OR-reduction tree over 255 O-PINI2
...
module iszero256 (clk, rst, go, a, r, s, out);
...
wire nx0_0 = a[0] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_0 = a[2] ^ 1'b1;   // NOT childB, share-local (share 0)
...
MSKand_opini2_d2 u_or_0 (
    .ina({ina1_0, ina0_0}), .inb({a[3], ny0_0}),
    .rnd(r[0]), .s(s[0]), .clk(clk), .out({w1_0, w0_0}));
wire or0_0 = w0_0 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_0 = w1_0;
wire nx0_1 = a[4] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_1 = a[6] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_1 (
    .ina({ina1_1, ina0_1}), .inb({a[7], ny0_1}),
    .rnd(r[1]), .s(s[1]), .clk(clk), .out({w1_1, w0_1}));
wire or0_1 = w0_1 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_1 = w1_1;
wire nx0_2 = a[8] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_2 = a[10] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_2 (
    .ina({ina1_2, ina0_2}), .inb({a[11], ny0_2}),
    .rnd(r[2]), .s(s[2]), .clk(clk), .out({w1_2, w0_2}));
wire or0_2 = w0_2 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_2 = w1_2;
wire nx0_3 = a[12] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_3 = a[14] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_3 (
    .ina({ina1_3, ina0_3}), .inb({a[15], ny0_3}),
    .rnd(r[3]), .s(s[3]), .clk(clk), .out({w1_3, w0_3}));
wire or0_3 = w0_3 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_3 = w1_3;
wire nx0_4 = a[16] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_4 = a[18] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_4 (
    .ina({ina1_4, ina0_4}), .inb({a[19], ny0_4}),
    .rnd(r[4]), .s(s[4]), .clk(clk), .out({w1_4, w0_4}));
wire or0_4 = w0_4 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_4 = w1_4;
wire nx0_5 = a[20] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_5 = a[22] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_5 (
    .ina({ina1_5, ina0_5}), .inb({a[23], ny0_5}),
    .rnd(r[5]), .s(s[5]), .clk(clk), .out({w1_5, w0_5}));
wire or0_5 = w0_5 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_5 = w1_5;
wire nx0_6 = a[24] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_6 = a[26] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_6 (
    .ina({ina1_6, ina0_6}), .inb({a[27], ny0_6}),
    .rnd(r[6]), .s(s[6]), .clk(clk), .out({w1_6, w0_6}));
wire or0_6 = w0_6 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_6 = w1_6;
wire nx0_7 = a[28] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_7 = a[30] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_7 (
    .ina({ina1_7, ina0_7}), .inb({a[31], ny0_7}),
    .rnd(r[7]), .s(s[7]), .clk(clk), .out({w1_7, w0_7}));
wire or0_7 = w0_7 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_7 = w1_7;
wire nx0_8 = a[32] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_8 = a[34] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_8 (
    .ina({ina1_8, ina0_8}), .inb({a[35], ny0_8}),
    .rnd(r[8]), .s(s[8]), .clk(clk), .out({w1_8, w0_8}));
wire or0_8 = w0_8 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_8 = w1_8;
wire nx0_9 = a[36] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_9 = a[38] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_9 (
    .ina({ina1_9, ina0_9}), .inb({a[39], ny0_9}),
    .rnd(r[9]), .s(s[9]), .clk(clk), .out({w1_9, w0_9}));
wire or0_9 = w0_9 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_9 = w1_9;
wire nx0_10 = a[40] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_10 = a[42] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_10 (
    .ina({ina1_10, ina0_10}), .inb({a[43], ny0_10}),
    .rnd(r[10]), .s(s[10]), .clk(clk), .out({w1_10, w0_10}));
wire or0_10 = w0_10 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_10 = w1_10;
wire nx0_11 = a[44] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_11 = a[46] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_11 (
    .ina({ina1_11, ina0_11}), .inb({a[47], ny0_11}),
    .rnd(r[11]), .s(s[11]), .clk(clk), .out({w1_11, w0_11}));
wire or0_11 = w0_11 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_11 = w1_11;
wire nx0_12 = a[48] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_12 = a[50] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_12 (
    .ina({ina1_12, ina0_12}), .inb({a[51], ny0_12}),
    .rnd(r[12]), .s(s[12]), .clk(clk), .out({w1_12, w0_12}));
wire or0_12 = w0_12 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_12 = w1_12;
wire nx0_13 = a[52] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_13 = a[54] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_13 (
    .ina({ina1_13, ina0_13}), .inb({a[55], ny0_13}),
    .rnd(r[13]), .s(s[13]), .clk(clk), .out({w1_13, w0_13}));
wire or0_13 = w0_13 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_13 = w1_13;
wire nx0_14 = a[56] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_14 = a[58] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_14 (
    .ina({ina1_14, ina0_14}), .inb({a[59], ny0_14}),
    .rnd(r[14]), .s(s[14]), .clk(clk), .out({w1_14, w0_14}));
wire or0_14 = w0_14 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_14 = w1_14;
wire nx0_15 = a[60] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_15 = a[62] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_15 (
    .ina({ina1_15, ina0_15}), .inb({a[63], ny0_15}),
    .rnd(r[15]), .s(s[15]), .clk(clk), .out({w1_15, w0_15}));
wire or0_15 = w0_15 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_15 = w1_15;
wire nx0_16 = a[64] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_16 = a[66] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_16 (
    .ina({ina1_16, ina0_16}), .inb({a[67], ny0_16}),
    .rnd(r[16]), .s(s[16]), .clk(clk), .out({w1_16, w0_16}));
wire or0_16 = w0_16 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_16 = w1_16;
wire nx0_17 = a[68] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_17 = a[70] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_17 (
    .ina({ina1_17, ina0_17}), .inb({a[71], ny0_17}),
    .rnd(r[17]), .s(s[17]), .clk(clk), .out({w1_17, w0_17}));
wire or0_17 = w0_17 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_17 = w1_17;
wire nx0_18 = a[72] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_18 = a[74] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_18 (
    .ina({ina1_18, ina0_18}), .inb({a[75], ny0_18}),
    .rnd(r[18]), .s(s[18]), .clk(clk), .out({w1_18, w0_18}));
wire or0_18 = w0_18 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_18 = w1_18;
wire nx0_19 = a[76] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_19 = a[78] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_19 (
    .ina({ina1_19, ina0_19}), .inb({a[79], ny0_19}),
    .rnd(r[19]), .s(s[19]), .clk(clk), .out({w1_19, w0_19}));
wire or0_19 = w0_19 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_19 = w1_19;
wire nx0_20 = a[80] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_20 = a[82] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_20 (
    .ina({ina1_20, ina0_20}), .inb({a[83], ny0_20}),
    .rnd(r[20]), .s(s[20]), .clk(clk), .out({w1_20, w0_20}));
wire or0_20 = w0_20 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_20 = w1_20;
wire nx0_21 = a[84] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_21 = a[86] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_21 (
    .ina({ina1_21, ina0_21}), .inb({a[87], ny0_21}),
    .rnd(r[21]), .s(s[21]), .clk(clk), .out({w1_21, w0_21}));
wire or0_21 = w0_21 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_21 = w1_21;
wire nx0_22 = a[88] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_22 = a[90] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_22 (
    .ina({ina1_22, ina0_22}), .inb({a[91], ny0_22}),
    .rnd(r[22]), .s(s[22]), .clk(clk), .out({w1_22, w0_22}));
wire or0_22 = w0_22 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_22 = w1_22;
wire nx0_23 = a[92] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_23 = a[94] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_23 (
    .ina({ina1_23, ina0_23}), .inb({a[95], ny0_23}),
    .rnd(r[23]), .s(s[23]), .clk(clk), .out({w1_23, w0_23}));
wire or0_23 = w0_23 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_23 = w1_23;
wire nx0_24 = a[96] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_24 = a[98] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_24 (
    .ina({ina1_24, ina0_24}), .inb({a[99], ny0_24}),
    .rnd(r[24]), .s(s[24]), .clk(clk), .out({w1_24, w0_24}));
wire or0_24 = w0_24 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_24 = w1_24;
wire nx0_25 = a[100] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_25 = a[102] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_25 (
    .ina({ina1_25, ina0_25}), .inb({a[103], ny0_25}),
    .rnd(r[25]), .s(s[25]), .clk(clk), .out({w1_25, w0_25}));
wire or0_25 = w0_25 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_25 = w1_25;
wire nx0_26 = a[104] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_26 = a[106] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_26 (
    .ina({ina1_26, ina0_26}), .inb({a[107], ny0_26}),
    .rnd(r[26]), .s(s[26]), .clk(clk), .out({w1_26, w0_26}));
wire or0_26 = w0_26 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_26 = w1_26;
wire nx0_27 = a[108] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_27 = a[110] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_27 (
    .ina({ina1_27, ina0_27}), .inb({a[111], ny0_27}),
    .rnd(r[27]), .s(s[27]), .clk(clk), .out({w1_27, w0_27}));
wire or0_27 = w0_27 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_27 = w1_27;
wire nx0_28 = a[112] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_28 = a[114] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_28 (
    .ina({ina1_28, ina0_28}), .inb({a[115], ny0_28}),
    .rnd(r[28]), .s(s[28]), .clk(clk), .out({w1_28, w0_28}));
wire or0_28 = w0_28 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_28 = w1_28;
wire nx0_29 = a[116] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_29 = a[118] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_29 (
    .ina({ina1_29, ina0_29}), .inb({a[119], ny0_29}),
    .rnd(r[29]), .s(s[29]), .clk(clk), .out({w1_29, w0_29}));
wire or0_29 = w0_29 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_29 = w1_29;
wire nx0_30 = a[120] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_30 = a[122] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_30 (
    .ina({ina1_30, ina0_30}), .inb({a[123], ny0_30}),
    .rnd(r[30]), .s(s[30]), .clk(clk), .out({w1_30, w0_30}));
wire or0_30 = w0_30 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_30 = w1_30;
wire nx0_31 = a[124] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_31 = a[126] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_31 (
    .ina({ina1_31, ina0_31}), .inb({a[127], ny0_31}),
    .rnd(r[31]), .s(s[31]), .clk(clk), .out({w1_31, w0_31}));
wire or0_31 = w0_31 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_31 = w1_31;
wire nx0_32 = a[128] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_32 = a[130] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_32 (
    .ina({ina1_32, ina0_32}), .inb({a[131], ny0_32}),
    .rnd(r[32]), .s(s[32]), .clk(clk), .out({w1_32, w0_32}));
wire or0_32 = w0_32 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_32 = w1_32;
wire nx0_33 = a[132] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_33 = a[134] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_33 (
    .ina({ina1_33, ina0_33}), .inb({a[135], ny0_33}),
    .rnd(r[33]), .s(s[33]), .clk(clk), .out({w1_33, w0_33}));
wire or0_33 = w0_33 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_33 = w1_33;
wire nx0_34 = a[136] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_34 = a[138] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_34 (
    .ina({ina1_34, ina0_34}), .inb({a[139], ny0_34}),
    .rnd(r[34]), .s(s[34]), .clk(clk), .out({w1_34, w0_34}));
wire or0_34 = w0_34 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_34 = w1_34;
wire nx0_35 = a[140] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_35 = a[142] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_35 (
    .ina({ina1_35, ina0_35}), .inb({a[143], ny0_35}),
    .rnd(r[35]), .s(s[35]), .clk(clk), .out({w1_35, w0_35}));
wire or0_35 = w0_35 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_35 = w1_35;
wire nx0_36 = a[144] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_36 = a[146] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_36 (
    .ina({ina1_36, ina0_36}), .inb({a[147], ny0_36}),
    .rnd(r[36]), .s(s[36]), .clk(clk), .out({w1_36, w0_36}));
wire or0_36 = w0_36 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_36 = w1_36;
wire nx0_37 = a[148] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_37 = a[150] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_37 (
    .ina({ina1_37, ina0_37}), .inb({a[151], ny0_37}),
    .rnd(r[37]), .s(s[37]), .clk(clk), .out({w1_37, w0_37}));
wire or0_37 = w0_37 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_37 = w1_37;
wire nx0_38 = a[152] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_38 = a[154] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_38 (
    .ina({ina1_38, ina0_38}), .inb({a[155], ny0_38}),
    .rnd(r[38]), .s(s[38]), .clk(clk), .out({w1_38, w0_38}));
wire or0_38 = w0_38 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_38 = w1_38;
wire nx0_39 = a[156] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_39 = a[158] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_39 (
    .ina({ina1_39, ina0_39}), .inb({a[159], ny0_39}),
    .rnd(r[39]), .s(s[39]), .clk(clk), .out({w1_39, w0_39}));
wire or0_39 = w0_39 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_39 = w1_39;
wire nx0_40 = a[160] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_40 = a[162] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_40 (
    .ina({ina1_40, ina0_40}), .inb({a[163], ny0_40}),
    .rnd(r[40]), .s(s[40]), .clk(clk), .out({w1_40, w0_40}));
wire or0_40 = w0_40 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_40 = w1_40;
wire nx0_41 = a[164] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_41 = a[166] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_41 (
    .ina({ina1_41, ina0_41}), .inb({a[167], ny0_41}),
    .rnd(r[41]), .s(s[41]), .clk(clk), .out({w1_41, w0_41}));
wire or0_41 = w0_41 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_41 = w1_41;
wire nx0_42 = a[168] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_42 = a[170] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_42 (
    .ina({ina1_42, ina0_42}), .inb({a[171], ny0_42}),
    .rnd(r[42]), .s(s[42]), .clk(clk), .out({w1_42, w0_42}));
wire or0_42 = w0_42 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_42 = w1_42;
wire nx0_43 = a[172] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_43 = a[174] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_43 (
    .ina({ina1_43, ina0_43}), .inb({a[175], ny0_43}),
    .rnd(r[43]), .s(s[43]), .clk(clk), .out({w1_43, w0_43}));
wire or0_43 = w0_43 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_43 = w1_43;
wire nx0_44 = a[176] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_44 = a[178] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_44 (
    .ina({ina1_44, ina0_44}), .inb({a[179], ny0_44}),
    .rnd(r[44]), .s(s[44]), .clk(clk), .out({w1_44, w0_44}));
wire or0_44 = w0_44 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_44 = w1_44;
wire nx0_45 = a[180] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_45 = a[182] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_45 (
    .ina({ina1_45, ina0_45}), .inb({a[183], ny0_45}),
    .rnd(r[45]), .s(s[45]), .clk(clk), .out({w1_45, w0_45}));
wire or0_45 = w0_45 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_45 = w1_45;
wire nx0_46 = a[184] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_46 = a[186] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_46 (
    .ina({ina1_46, ina0_46}), .inb({a[187], ny0_46}),
    .rnd(r[46]), .s(s[46]), .clk(clk), .out({w1_46, w0_46}));
wire or0_46 = w0_46 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_46 = w1_46;
wire nx0_47 = a[188] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_47 = a[190] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_47 (
    .ina({ina1_47, ina0_47}), .inb({a[191], ny0_47}),
    .rnd(r[47]), .s(s[47]), .clk(clk), .out({w1_47, w0_47}));
wire or0_47 = w0_47 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_47 = w1_47;
wire nx0_48 = a[192] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_48 = a[194] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_48 (
    .ina({ina1_48, ina0_48}), .inb({a[195], ny0_48}),
    .rnd(r[48]), .s(s[48]), .clk(clk), .out({w1_48, w0_48}));
wire or0_48 = w0_48 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_48 = w1_48;
wire nx0_49 = a[196] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_49 = a[198] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_49 (
    .ina({ina1_49, ina0_49}), .inb({a[199], ny0_49}),
    .rnd(r[49]), .s(s[49]), .clk(clk), .out({w1_49, w0_49}));
wire or0_49 = w0_49 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_49 = w1_49;
wire nx0_50 = a[200] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_50 = a[202] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_50 (
    .ina({ina1_50, ina0_50}), .inb({a[203], ny0_50}),
    .rnd(r[50]), .s(s[50]), .clk(clk), .out({w1_50, w0_50}));
wire or0_50 = w0_50 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_50 = w1_50;
wire nx0_51 = a[204] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_51 = a[206] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_51 (
    .ina({ina1_51, ina0_51}), .inb({a[207], ny0_51}),
    .rnd(r[51]), .s(s[51]), .clk(clk), .out({w1_51, w0_51}));
wire or0_51 = w0_51 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_51 = w1_51;
wire nx0_52 = a[208] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_52 = a[210] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_52 (
    .ina({ina1_52, ina0_52}), .inb({a[211], ny0_52}),
    .rnd(r[52]), .s(s[52]), .clk(clk), .out({w1_52, w0_52}));
wire or0_52 = w0_52 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_52 = w1_52;
wire nx0_53 = a[212] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_53 = a[214] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_53 (
    .ina({ina1_53, ina0_53}), .inb({a[215], ny0_53}),
    .rnd(r[53]), .s(s[53]), .clk(clk), .out({w1_53, w0_53}));
wire or0_53 = w0_53 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_53 = w1_53;
wire nx0_54 = a[216] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_54 = a[218] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_54 (
    .ina({ina1_54, ina0_54}), .inb({a[219], ny0_54}),
    .rnd(r[54]), .s(s[54]), .clk(clk), .out({w1_54, w0_54}));
wire or0_54 = w0_54 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_54 = w1_54;
wire nx0_55 = a[220] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_55 = a[222] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_55 (
    .ina({ina1_55, ina0_55}), .inb({a[223], ny0_55}),
    .rnd(r[55]), .s(s[55]), .clk(clk), .out({w1_55, w0_55}));
wire or0_55 = w0_55 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_55 = w1_55;
wire nx0_56 = a[224] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_56 = a[226] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_56 (
    .ina({ina1_56, ina0_56}), .inb({a[227], ny0_56}),
    .rnd(r[56]), .s(s[56]), .clk(clk), .out({w1_56, w0_56}));
wire or0_56 = w0_56 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_56 = w1_56;
wire nx0_57 = a[228] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_57 = a[230] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_57 (
    .ina({ina1_57, ina0_57}), .inb({a[231], ny0_57}),
    .rnd(r[57]), .s(s[57]), .clk(clk), .out({w1_57, w0_57}));
wire or0_57 = w0_57 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_57 = w1_57;
wire nx0_58 = a[232] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_58 = a[234] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_58 (
    .ina({ina1_58, ina0_58}), .inb({a[235], ny0_58}),
    .rnd(r[58]), .s(s[58]), .clk(clk), .out({w1_58, w0_58}));
wire or0_58 = w0_58 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_58 = w1_58;
wire nx0_59 = a[236] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_59 = a[238] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_59 (
    .ina({ina1_59, ina0_59}), .inb({a[239], ny0_59}),
    .rnd(r[59]), .s(s[59]), .clk(clk), .out({w1_59, w0_59}));
wire or0_59 = w0_59 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_59 = w1_59;
wire nx0_60 = a[240] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_60 = a[242] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_60 (
    .ina({ina1_60, ina0_60}), .inb({a[243], ny0_60}),
    .rnd(r[60]), .s(s[60]), .clk(clk), .out({w1_60, w0_60}));
wire or0_60 = w0_60 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_60 = w1_60;
wire nx0_61 = a[244] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_61 = a[246] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_61 (
    .ina({ina1_61, ina0_61}), .inb({a[247], ny0_61}),
    .rnd(r[61]), .s(s[61]), .clk(clk), .out({w1_61, w0_61}));
wire or0_61 = w0_61 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_61 = w1_61;
wire nx0_62 = a[248] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_62 = a[250] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_62 (
    .ina({ina1_62, ina0_62}), .inb({a[251], ny0_62}),
    .rnd(r[62]), .s(s[62]), .clk(clk), .out({w1_62, w0_62}));
wire or0_62 = w0_62 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_62 = w1_62;
wire nx0_63 = a[252] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_63 = a[254] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_63 (
    .ina({ina1_63, ina0_63}), .inb({a[255], ny0_63}),
    .rnd(r[63]), .s(s[63]), .clk(clk), .out({w1_63, w0_63}));
wire or0_63 = w0_63 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_63 = w1_63;
wire nx0_64 = a[256] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_64 = a[258] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_64 (
    .ina({ina1_64, ina0_64}), .inb({a[259], ny0_64}),
    .rnd(r[64]), .s(s[64]), .clk(clk), .out({w1_64, w0_64}));
wire or0_64 = w0_64 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_64 = w1_64;
wire nx0_65 = a[260] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_65 = a[262] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_65 (
    .ina({ina1_65, ina0_65}), .inb({a[263], ny0_65}),
    .rnd(r[65]), .s(s[65]), .clk(clk), .out({w1_65, w0_65}));
wire or0_65 = w0_65 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_65 = w1_65;
wire nx0_66 = a[264] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_66 = a[266] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_66 (
    .ina({ina1_66, ina0_66}), .inb({a[267], ny0_66}),
    .rnd(r[66]), .s(s[66]), .clk(clk), .out({w1_66, w0_66}));
wire or0_66 = w0_66 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_66 = w1_66;
wire nx0_67 = a[268] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_67 = a[270] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_67 (
    .ina({ina1_67, ina0_67}), .inb({a[271], ny0_67}),
    .rnd(r[67]), .s(s[67]), .clk(clk), .out({w1_67, w0_67}));
wire or0_67 = w0_67 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_67 = w1_67;
wire nx0_68 = a[272] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_68 = a[274] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_68 (
    .ina({ina1_68, ina0_68}), .inb({a[275], ny0_68}),
    .rnd(r[68]), .s(s[68]), .clk(clk), .out({w1_68, w0_68}));
wire or0_68 = w0_68 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_68 = w1_68;
wire nx0_69 = a[276] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_69 = a[278] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_69 (
    .ina({ina1_69, ina0_69}), .inb({a[279], ny0_69}),
    .rnd(r[69]), .s(s[69]), .clk(clk), .out({w1_69, w0_69}));
wire or0_69 = w0_69 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_69 = w1_69;
wire nx0_70 = a[280] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_70 = a[282] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_70 (
    .ina({ina1_70, ina0_70}), .inb({a[283], ny0_70}),
    .rnd(r[70]), .s(s[70]), .clk(clk), .out({w1_70, w0_70}));
wire or0_70 = w0_70 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_70 = w1_70;
wire nx0_71 = a[284] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_71 = a[286] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_71 (
    .ina({ina1_71, ina0_71}), .inb({a[287], ny0_71}),
    .rnd(r[71]), .s(s[71]), .clk(clk), .out({w1_71, w0_71}));
wire or0_71 = w0_71 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_71 = w1_71;
wire nx0_72 = a[288] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_72 = a[290] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_72 (
    .ina({ina1_72, ina0_72}), .inb({a[291], ny0_72}),
    .rnd(r[72]), .s(s[72]), .clk(clk), .out({w1_72, w0_72}));
wire or0_72 = w0_72 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_72 = w1_72;
wire nx0_73 = a[292] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_73 = a[294] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_73 (
    .ina({ina1_73, ina0_73}), .inb({a[295], ny0_73}),
    .rnd(r[73]), .s(s[73]), .clk(clk), .out({w1_73, w0_73}));
wire or0_73 = w0_73 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_73 = w1_73;
wire nx0_74 = a[296] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_74 = a[298] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_74 (
    .ina({ina1_74, ina0_74}), .inb({a[299], ny0_74}),
    .rnd(r[74]), .s(s[74]), .clk(clk), .out({w1_74, w0_74}));
wire or0_74 = w0_74 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_74 = w1_74;
wire nx0_75 = a[300] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_75 = a[302] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_75 (
    .ina({ina1_75, ina0_75}), .inb({a[303], ny0_75}),
    .rnd(r[75]), .s(s[75]), .clk(clk), .out({w1_75, w0_75}));
wire or0_75 = w0_75 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_75 = w1_75;
wire nx0_76 = a[304] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_76 = a[306] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_76 (
    .ina({ina1_76, ina0_76}), .inb({a[307], ny0_76}),
    .rnd(r[76]), .s(s[76]), .clk(clk), .out({w1_76, w0_76}));
wire or0_76 = w0_76 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_76 = w1_76;
wire nx0_77 = a[308] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_77 = a[310] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_77 (
    .ina({ina1_77, ina0_77}), .inb({a[311], ny0_77}),
    .rnd(r[77]), .s(s[77]), .clk(clk), .out({w1_77, w0_77}));
wire or0_77 = w0_77 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_77 = w1_77;
wire nx0_78 = a[312] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_78 = a[314] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_78 (
    .ina({ina1_78, ina0_78}), .inb({a[315], ny0_78}),
    .rnd(r[78]), .s(s[78]), .clk(clk), .out({w1_78, w0_78}));
wire or0_78 = w0_78 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_78 = w1_78;
wire nx0_79 = a[316] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_79 = a[318] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_79 (
    .ina({ina1_79, ina0_79}), .inb({a[319], ny0_79}),
    .rnd(r[79]), .s(s[79]), .clk(clk), .out({w1_79, w0_79}));
wire or0_79 = w0_79 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_79 = w1_79;
wire nx0_80 = a[320] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_80 = a[322] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_80 (
    .ina({ina1_80, ina0_80}), .inb({a[323], ny0_80}),
    .rnd(r[80]), .s(s[80]), .clk(clk), .out({w1_80, w0_80}));
wire or0_80 = w0_80 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_80 = w1_80;
wire nx0_81 = a[324] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_81 = a[326] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_81 (
    .ina({ina1_81, ina0_81}), .inb({a[327], ny0_81}),
    .rnd(r[81]), .s(s[81]), .clk(clk), .out({w1_81, w0_81}));
wire or0_81 = w0_81 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_81 = w1_81;
wire nx0_82 = a[328] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_82 = a[330] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_82 (
    .ina({ina1_82, ina0_82}), .inb({a[331], ny0_82}),
    .rnd(r[82]), .s(s[82]), .clk(clk), .out({w1_82, w0_82}));
wire or0_82 = w0_82 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_82 = w1_82;
wire nx0_83 = a[332] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_83 = a[334] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_83 (
    .ina({ina1_83, ina0_83}), .inb({a[335], ny0_83}),
    .rnd(r[83]), .s(s[83]), .clk(clk), .out({w1_83, w0_83}));
wire or0_83 = w0_83 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_83 = w1_83;
wire nx0_84 = a[336] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_84 = a[338] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_84 (
    .ina({ina1_84, ina0_84}), .inb({a[339], ny0_84}),
    .rnd(r[84]), .s(s[84]), .clk(clk), .out({w1_84, w0_84}));
wire or0_84 = w0_84 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_84 = w1_84;
wire nx0_85 = a[340] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_85 = a[342] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_85 (
    .ina({ina1_85, ina0_85}), .inb({a[343], ny0_85}),
    .rnd(r[85]), .s(s[85]), .clk(clk), .out({w1_85, w0_85}));
wire or0_85 = w0_85 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_85 = w1_85;
wire nx0_86 = a[344] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_86 = a[346] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_86 (
    .ina({ina1_86, ina0_86}), .inb({a[347], ny0_86}),
    .rnd(r[86]), .s(s[86]), .clk(clk), .out({w1_86, w0_86}));
wire or0_86 = w0_86 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_86 = w1_86;
wire nx0_87 = a[348] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_87 = a[350] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_87 (
    .ina({ina1_87, ina0_87}), .inb({a[351], ny0_87}),
    .rnd(r[87]), .s(s[87]), .clk(clk), .out({w1_87, w0_87}));
wire or0_87 = w0_87 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_87 = w1_87;
wire nx0_88 = a[352] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_88 = a[354] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_88 (
    .ina({ina1_88, ina0_88}), .inb({a[355], ny0_88}),
    .rnd(r[88]), .s(s[88]), .clk(clk), .out({w1_88, w0_88}));
wire or0_88 = w0_88 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_88 = w1_88;
wire nx0_89 = a[356] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_89 = a[358] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_89 (
    .ina({ina1_89, ina0_89}), .inb({a[359], ny0_89}),
    .rnd(r[89]), .s(s[89]), .clk(clk), .out({w1_89, w0_89}));
wire or0_89 = w0_89 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_89 = w1_89;
wire nx0_90 = a[360] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_90 = a[362] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_90 (
    .ina({ina1_90, ina0_90}), .inb({a[363], ny0_90}),
    .rnd(r[90]), .s(s[90]), .clk(clk), .out({w1_90, w0_90}));
wire or0_90 = w0_90 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_90 = w1_90;
wire nx0_91 = a[364] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_91 = a[366] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_91 (
    .ina({ina1_91, ina0_91}), .inb({a[367], ny0_91}),
    .rnd(r[91]), .s(s[91]), .clk(clk), .out({w1_91, w0_91}));
wire or0_91 = w0_91 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_91 = w1_91;
wire nx0_92 = a[368] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_92 = a[370] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_92 (
    .ina({ina1_92, ina0_92}), .inb({a[371], ny0_92}),
    .rnd(r[92]), .s(s[92]), .clk(clk), .out({w1_92, w0_92}));
wire or0_92 = w0_92 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_92 = w1_92;
wire nx0_93 = a[372] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_93 = a[374] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_93 (
    .ina({ina1_93, ina0_93}), .inb({a[375], ny0_93}),
    .rnd(r[93]), .s(s[93]), .clk(clk), .out({w1_93, w0_93}));
wire or0_93 = w0_93 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_93 = w1_93;
wire nx0_94 = a[376] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_94 = a[378] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_94 (
    .ina({ina1_94, ina0_94}), .inb({a[379], ny0_94}),
    .rnd(r[94]), .s(s[94]), .clk(clk), .out({w1_94, w0_94}));
wire or0_94 = w0_94 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_94 = w1_94;
wire nx0_95 = a[380] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_95 = a[382] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_95 (
    .ina({ina1_95, ina0_95}), .inb({a[383], ny0_95}),
    .rnd(r[95]), .s(s[95]), .clk(clk), .out({w1_95, w0_95}));
wire or0_95 = w0_95 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_95 = w1_95;
wire nx0_96 = a[384] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_96 = a[386] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_96 (
    .ina({ina1_96, ina0_96}), .inb({a[387], ny0_96}),
    .rnd(r[96]), .s(s[96]), .clk(clk), .out({w1_96, w0_96}));
wire or0_96 = w0_96 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_96 = w1_96;
wire nx0_97 = a[388] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_97 = a[390] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_97 (
    .ina({ina1_97, ina0_97}), .inb({a[391], ny0_97}),
    .rnd(r[97]), .s(s[97]), .clk(clk), .out({w1_97, w0_97}));
wire or0_97 = w0_97 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_97 = w1_97;
wire nx0_98 = a[392] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_98 = a[394] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_98 (
    .ina({ina1_98, ina0_98}), .inb({a[395], ny0_98}),
    .rnd(r[98]), .s(s[98]), .clk(clk), .out({w1_98, w0_98}));
wire or0_98 = w0_98 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_98 = w1_98;
wire nx0_99 = a[396] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_99 = a[398] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_99 (
    .ina({ina1_99, ina0_99}), .inb({a[399], ny0_99}),
    .rnd(r[99]), .s(s[99]), .clk(clk), .out({w1_99, w0_99}));
wire or0_99 = w0_99 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_99 = w1_99;
wire nx0_100 = a[400] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_100 = a[402] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_100 (
    .ina({ina1_100, ina0_100}), .inb({a[403], ny0_100}),
    .rnd(r[100]), .s(s[100]), .clk(clk), .out({w1_100, w0_100}));
wire or0_100 = w0_100 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_100 = w1_100;
wire nx0_101 = a[404] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_101 = a[406] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_101 (
    .ina({ina1_101, ina0_101}), .inb({a[407], ny0_101}),
    .rnd(r[101]), .s(s[101]), .clk(clk), .out({w1_101, w0_101}));
wire or0_101 = w0_101 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_101 = w1_101;
wire nx0_102 = a[408] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_102 = a[410] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_102 (
    .ina({ina1_102, ina0_102}), .inb({a[411], ny0_102}),
    .rnd(r[102]), .s(s[102]), .clk(clk), .out({w1_102, w0_102}));
wire or0_102 = w0_102 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_102 = w1_102;
wire nx0_103 = a[412] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_103 = a[414] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_103 (
    .ina({ina1_103, ina0_103}), .inb({a[415], ny0_103}),
    .rnd(r[103]), .s(s[103]), .clk(clk), .out({w1_103, w0_103}));
wire or0_103 = w0_103 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_103 = w1_103;
wire nx0_104 = a[416] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_104 = a[418] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_104 (
    .ina({ina1_104, ina0_104}), .inb({a[419], ny0_104}),
    .rnd(r[104]), .s(s[104]), .clk(clk), .out({w1_104, w0_104}));
wire or0_104 = w0_104 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_104 = w1_104;
wire nx0_105 = a[420] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_105 = a[422] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_105 (
    .ina({ina1_105, ina0_105}), .inb({a[423], ny0_105}),
    .rnd(r[105]), .s(s[105]), .clk(clk), .out({w1_105, w0_105}));
wire or0_105 = w0_105 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_105 = w1_105;
wire nx0_106 = a[424] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_106 = a[426] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_106 (
    .ina({ina1_106, ina0_106}), .inb({a[427], ny0_106}),
    .rnd(r[106]), .s(s[106]), .clk(clk), .out({w1_106, w0_106}));
wire or0_106 = w0_106 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_106 = w1_106;
wire nx0_107 = a[428] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_107 = a[430] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_107 (
    .ina({ina1_107, ina0_107}), .inb({a[431], ny0_107}),
    .rnd(r[107]), .s(s[107]), .clk(clk), .out({w1_107, w0_107}));
wire or0_107 = w0_107 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_107 = w1_107;
wire nx0_108 = a[432] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_108 = a[434] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_108 (
    .ina({ina1_108, ina0_108}), .inb({a[435], ny0_108}),
    .rnd(r[108]), .s(s[108]), .clk(clk), .out({w1_108, w0_108}));
wire or0_108 = w0_108 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_108 = w1_108;
wire nx0_109 = a[436] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_109 = a[438] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_109 (
    .ina({ina1_109, ina0_109}), .inb({a[439], ny0_109}),
    .rnd(r[109]), .s(s[109]), .clk(clk), .out({w1_109, w0_109}));
wire or0_109 = w0_109 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_109 = w1_109;
wire nx0_110 = a[440] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_110 = a[442] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_110 (
    .ina({ina1_110, ina0_110}), .inb({a[443], ny0_110}),
    .rnd(r[110]), .s(s[110]), .clk(clk), .out({w1_110, w0_110}));
wire or0_110 = w0_110 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_110 = w1_110;
wire nx0_111 = a[444] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_111 = a[446] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_111 (
    .ina({ina1_111, ina0_111}), .inb({a[447], ny0_111}),
    .rnd(r[111]), .s(s[111]), .clk(clk), .out({w1_111, w0_111}));
wire or0_111 = w0_111 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_111 = w1_111;
wire nx0_112 = a[448] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_112 = a[450] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_112 (
    .ina({ina1_112, ina0_112}), .inb({a[451], ny0_112}),
    .rnd(r[112]), .s(s[112]), .clk(clk), .out({w1_112, w0_112}));
wire or0_112 = w0_112 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_112 = w1_112;
wire nx0_113 = a[452] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_113 = a[454] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_113 (
    .ina({ina1_113, ina0_113}), .inb({a[455], ny0_113}),
    .rnd(r[113]), .s(s[113]), .clk(clk), .out({w1_113, w0_113}));
wire or0_113 = w0_113 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_113 = w1_113;
wire nx0_114 = a[456] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_114 = a[458] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_114 (
    .ina({ina1_114, ina0_114}), .inb({a[459], ny0_114}),
    .rnd(r[114]), .s(s[114]), .clk(clk), .out({w1_114, w0_114}));
wire or0_114 = w0_114 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_114 = w1_114;
wire nx0_115 = a[460] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_115 = a[462] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_115 (
    .ina({ina1_115, ina0_115}), .inb({a[463], ny0_115}),
    .rnd(r[115]), .s(s[115]), .clk(clk), .out({w1_115, w0_115}));
wire or0_115 = w0_115 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_115 = w1_115;
wire nx0_116 = a[464] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_116 = a[466] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_116 (
    .ina({ina1_116, ina0_116}), .inb({a[467], ny0_116}),
    .rnd(r[116]), .s(s[116]), .clk(clk), .out({w1_116, w0_116}));
wire or0_116 = w0_116 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_116 = w1_116;
wire nx0_117 = a[468] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_117 = a[470] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_117 (
    .ina({ina1_117, ina0_117}), .inb({a[471], ny0_117}),
    .rnd(r[117]), .s(s[117]), .clk(clk), .out({w1_117, w0_117}));
wire or0_117 = w0_117 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_117 = w1_117;
wire nx0_118 = a[472] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_118 = a[474] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_118 (
    .ina({ina1_118, ina0_118}), .inb({a[475], ny0_118}),
    .rnd(r[118]), .s(s[118]), .clk(clk), .out({w1_118, w0_118}));
wire or0_118 = w0_118 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_118 = w1_118;
wire nx0_119 = a[476] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_119 = a[478] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_119 (
    .ina({ina1_119, ina0_119}), .inb({a[479], ny0_119}),
    .rnd(r[119]), .s(s[119]), .clk(clk), .out({w1_119, w0_119}));
wire or0_119 = w0_119 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_119 = w1_119;
wire nx0_120 = a[480] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_120 = a[482] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_120 (
    .ina({ina1_120, ina0_120}), .inb({a[483], ny0_120}),
    .rnd(r[120]), .s(s[120]), .clk(clk), .out({w1_120, w0_120}));
wire or0_120 = w0_120 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_120 = w1_120;
wire nx0_121 = a[484] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_121 = a[486] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_121 (
    .ina({ina1_121, ina0_121}), .inb({a[487], ny0_121}),
    .rnd(r[121]), .s(s[121]), .clk(clk), .out({w1_121, w0_121}));
wire or0_121 = w0_121 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_121 = w1_121;
wire nx0_122 = a[488] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_122 = a[490] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_122 (
    .ina({ina1_122, ina0_122}), .inb({a[491], ny0_122}),
    .rnd(r[122]), .s(s[122]), .clk(clk), .out({w1_122, w0_122}));
wire or0_122 = w0_122 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_122 = w1_122;
wire nx0_123 = a[492] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_123 = a[494] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_123 (
    .ina({ina1_123, ina0_123}), .inb({a[495], ny0_123}),
    .rnd(r[123]), .s(s[123]), .clk(clk), .out({w1_123, w0_123}));
wire or0_123 = w0_123 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_123 = w1_123;
wire nx0_124 = a[496] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_124 = a[498] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_124 (
    .ina({ina1_124, ina0_124}), .inb({a[499], ny0_124}),
    .rnd(r[124]), .s(s[124]), .clk(clk), .out({w1_124, w0_124}));
wire or0_124 = w0_124 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_124 = w1_124;
wire nx0_125 = a[500] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_125 = a[502] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_125 (
    .ina({ina1_125, ina0_125}), .inb({a[503], ny0_125}),
    .rnd(r[125]), .s(s[125]), .clk(clk), .out({w1_125, w0_125}));
wire or0_125 = w0_125 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_125 = w1_125;
wire nx0_126 = a[504] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_126 = a[506] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_126 (
    .ina({ina1_126, ina0_126}), .inb({a[507], ny0_126}),
    .rnd(r[126]), .s(s[126]), .clk(clk), .out({w1_126, w0_126}));
wire or0_126 = w0_126 ^ 1'b1;   // OR = NOT(AND(..)), share-local (share 0)
wire or1_126 = w1_126;
wire nx0_127 = a[508] ^ 1'b1;   // NOT childA, share-local (share 0)
wire ny0_127 = a[510] ^ 1'b1;   // NOT childB, share-local (share 0)
// 1-cycle balance reg on the ina path (share-local, per-share): presents ina
// one cycle after inb, matching the gadget's ina@1 / inb@0 latency contract —
// the tree analog of the adder's staggered a_act/b_act windows.
...
MSKand_opini2_d2 u_or_127 (
    .ina({ina1_127, ina0_127}), .inb({a[511], ny0_127}),
