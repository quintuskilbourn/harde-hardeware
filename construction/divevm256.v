// 256-bit masked EVM DIV/MOD (q = B==0 ? 0 : A/B, rem = B==0 ? 0 : A%B)
// — restoring-divider core + nonzero tree + zero-gating, 1537 O-PINI2
...
module divevm256 (clk, rst, go, a, b, r, s, qe, reme);
