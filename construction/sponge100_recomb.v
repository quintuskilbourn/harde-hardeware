// NEGATIVE CONTROL (must FAIL): CLEAN keccakf100 core; the bug is
// planted in the NEW absorb stage (leak0 <= a[0]^a[1]) — proves
// MATCHI checks the sponge wiring itself, not just the core.
// Masked Keccak-f[100] — dedicated masked round unit (100 O-PINI2 chi
// leaves) iterated over all 16 rounds. VERIFIED TARGET.
...
module sponge100_recomb (clk, rst, go, st, m, r, s, o, leak_o);
(* matchi_type = "clock" *)   input clk;
(* matchi_type = "control" *) input rst;
(* matchi_type = "control" *) input go;
(* matchi_type = "sharings_dense", matchi_active = "a_act" *) input [199:0] st;
(* matchi_type = "sharings_dense", matchi_active = "a_act" *) input [63:0] m;
...
wire ab_64 = st[64] ^ 1'b1;  wire ab_65 = st[65];
wire ab_66 = st[66];  wire ab_67 = st[67];
wire ab_68 = st[68];  wire ab_69 = st[69];
wire ab_70 = st[70];  wire ab_71 = st[71];
wire ab_72 = st[72];  wire ab_73 = st[73];
wire ab_74 = st[74];  wire ab_75 = st[75];
wire ab_76 = st[76];  wire ab_77 = st[77];
wire ab_78 = st[78];  wire ab_79 = st[79];
wire ab_80 = st[80];  wire ab_81 = st[81];
wire ab_82 = st[82];  wire ab_83 = st[83];
wire ab_84 = st[84];  wire ab_85 = st[85];
wire ab_86 = st[86];  wire ab_87 = st[87];
wire ab_88 = st[88];  wire ab_89 = st[89];
wire ab_90 = st[90];  wire ab_91 = st[91];
wire ab_92 = st[92];  wire ab_93 = st[93];
wire ab_94 = st[94];  wire ab_95 = st[95];
wire ab_96 = st[96];  wire ab_97 = st[97];
wire ab_98 = st[98];  wire ab_99 = st[99];
wire ab_100 = st[100];  wire ab_101 = st[101];
wire ab_102 = st[102];  wire ab_103 = st[103];
wire ab_104 = st[104];  wire ab_105 = st[105];
wire ab_106 = st[106];  wire ab_107 = st[107];
wire ab_108 = st[108];  wire ab_109 = st[109];
wire ab_110 = st[110];  wire ab_111 = st[111];
wire ab_112 = st[112];  wire ab_113 = st[113];
wire ab_114 = st[114];  wire ab_115 = st[115];
wire ab_116 = st[116];  wire ab_117 = st[117];
wire ab_118 = st[118];  wire ab_119 = st[119];
wire ab_120 = st[120];  wire ab_121 = st[121];
wire ab_122 = st[122];  wire ab_123 = st[123];
wire ab_124 = st[124];  wire ab_125 = st[125];
wire ab_126 = st[126];  wire ab_127 = st[127];
wire ab_128 = st[128];  wire ab_129 = st[129];
wire ab_130 = st[130];  wire ab_131 = st[131];
wire ab_132 = st[132];  wire ab_133 = st[133];
wire ab_134 = st[134] ^ 1'b1;  wire ab_135 = st[135];
wire ab_136 = st[136];  wire ab_137 = st[137];
wire ab_138 = st[138];  wire ab_139 = st[139];
wire ab_140 = st[140];  wire ab_141 = st[141];
wire ab_142 = st[142];  wire ab_143 = st[143];
wire ab_144 = st[144];  wire ab_145 = st[145];
wire ab_146 = st[146];  wire ab_147 = st[147];
wire ab_148 = st[148];  wire ab_149 = st[149];
wire ab_150 = st[150];  wire ab_151 = st[151];
wire ab_152 = st[152];  wire ab_153 = st[153];
wire ab_154 = st[154];  wire ab_155 = st[155];
wire ab_156 = st[156];  wire ab_157 = st[157];
wire ab_158 = st[158];  wire ab_159 = st[159];
wire ab_160 = st[160];  wire ab_161 = st[161];
wire ab_162 = st[162];  wire ab_163 = st[163];
wire ab_164 = st[164];  wire ab_165 = st[165];
wire ab_166 = st[166];  wire ab_167 = st[167];
wire ab_168 = st[168];  wire ab_169 = st[169];
wire ab_170 = st[170];  wire ab_171 = st[171];
wire ab_172 = st[172];  wire ab_173 = st[173];
wire ab_174 = st[174];  wire ab_175 = st[175];
wire ab_176 = st[176];  wire ab_177 = st[177];
wire ab_178 = st[178];  wire ab_179 = st[179];
wire ab_180 = st[180];  wire ab_181 = st[181];
wire ab_182 = st[182];  wire ab_183 = st[183];
wire ab_184 = st[184];  wire ab_185 = st[185];
wire ab_186 = st[186];  wire ab_187 = st[187];
wire ab_188 = st[188];  wire ab_189 = st[189];
wire ab_190 = st[190];  wire ab_191 = st[191];
wire ab_192 = st[192];  wire ab_193 = st[193];
wire ab_194 = st[194];  wire ab_195 = st[195];
wire ab_196 = st[196];  wire ab_197 = st[197];
wire ab_198 = st[198];  wire ab_199 = st[199];
